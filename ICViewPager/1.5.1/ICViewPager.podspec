Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/hjanuschka/ICViewPager"
  s.screenshots  = "https://raw.githubusercontent.com/hjanuschka/ICViewPager/master/Resources/Screenshot.jpg"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { "Ilter Cengiz" => "me@iltercengiz.info" }
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/hjanuschka/ICViewPager.git", :branch => "master" }
